   ...
   public static Player readPlayerFromFile(String fileName)
   {
      try
      {
         ...
         {  
            ...
            {
               mapMark[i] = Integer.parseInt(mapNums[i].trim());
            }
         ...
         //code to read potions from file: Line 4
            ...
            String[] potionNums = line.split(" ");
            for(int i = 0; i<potions.length; i++)
            {
               potions[i] = Integer.parseInt(potionNums[i].trim());
            }
            ...
            String[] flowerNums = line.split(" ");
            for(int i = 0; i<flowerBoxCount.length; i++)
            {
               flowerBoxCount[i] = Integer.parseInt(flowerNums[i].trim());
            }
         ...
         //code to read specificExperience from file: Line 6
            ...
            String[] experienceNums = line.split(" ");
            for(int i = 0; i<specificExperience.length; i++)
            {
               specificExperience[i] = Integer.parseInt(experienceNums[i].trim());
            }
            ...
            String[] statNums = line.split(" ");
            for(int i = 0; i<stats.length; i++)
            {
               stats[i] = Integer.parseInt(statNums[i].trim());
            }
            ...
            String[] indexNums = line.split(" ");
            for(int i = 0; i<infoIndexes.length; i++)
            {
               infoIndexes[i] = Integer.parseInt(indexNums[i].trim());
            }
          ...
          //code to read spellHotKeys from file: Line 9
            ...
            String[] spellHotKeyNums = line.split(" ");
            for(int i = 0; i<spellHotKeys.length; i++)
            {
               spellHotKeys[i] = Integer.parseInt(spellHotKeyNums[i].trim());
            }
            ...
            String[] potionHotKeyNums = line.split(" ");
            for(int i = 0; i<potionHotKeys.length; i++)
            {
               potionHotKeys[i] = Integer.parseInt(potionHotKeyNums[i].trim());
            }
          ...
          //code to read weaponHotKeys from file: Line 11
            ...
            String[] weaponHotKeyNums = line.split(" ");
            int count = 0;
            for(int i = 0; i < weaponHotKeyNums.length; i=i+2)
            {
               weaponHotKeys[count] = new Point(Integer.parseInt(weaponHotKeyNums[i].trim()), Integer.parseInt(weaponHotKeyNums[i+1].trim()));
               count++;
            }
          ...
          //code to read effects from file: Line 12
            ...
            if(line.length() > 3)
            {
               ...
               String[] effectParts = line.split(",");
               for(int i = 0; i<effectParts.length; i++)
               {
                  effects.add(effectParts[i].trim());
               }
            }
            //******************************************************************/
            if(effects==null)
            ...
            if(line.length() > 3)
            {
               ...
               {
                  fileNames.add(fileNameParts[i].trim());
               }
            }
          ...
          //code to read items from file: Line 14
            ...
            if(line.length() > 3)
            {
               ...
               {
                  spells.add(Spell.getSpellWithName(spellParts[i].trim()));
               }
            }
          ...
          //code to read teleporter memory from file: Line 16
            ...
            {
               line = line.substring(1,line.length()-1);
               String[] teleporterNums = line.split(",");
               for(int i = 0; i < teleporterNums.length; i++)
               {
                  String trimmed = teleporterNums[i].trim();
                  String part = trimmed.substring(1, trimmed.length()-1);
                  String[] parts = part.split(" ");
                  memory.add(new Teleporter(Integer.parseInt(parts[0].trim()),Integer.parseInt(parts[1].trim()),Integer.parseInt(parts[2].trim()),parts[3].trim()));
               }
            }
          ...
          //code to read armorSet and armorFreq from file: Line 17
            ...
            {
               line = line.substring(1, line.length()-1);
               String[] armorSetParts = line.split(",");
               for(int i = 0; i<armorSetParts.length; i++)
               {
                  String trimmed = armorSetParts[i].trim();
                  String armorType = trimmed.substring(0, trimmed.indexOf(":"));
                  String armorFrequency = trimmed.substring(trimmed.indexOf(":")+1, trimmed.length());
                  armorSet.add(Armor.getArmorWithName(armorType));
                  armorFreq.add(Integer.parseInt(armorFrequency));
               }
            }
            //******************************************************************/
          ...
          //code to read weapons and weaponFrequencies from file: Lines 18-32
            ...
            for(int i = 0; i < weapons.length; i++)
            {
               ...
               ArrayList<Integer> weaponFrequencies1 = new ArrayList<Integer>();
               if(line.length() > 3)
               {
                  line = line.substring(1, line.length()-1);
                  String[] weaponParts = line.split(",");
                  for(int j = 0; j<weaponParts.length; j++)
                  {
                     String trimmed = weaponParts[j].trim();
                     String weaponType = trimmed.substring(0, trimmed.indexOf(":"));
                     String weaponFrequency = trimmed.substring(trimmed.indexOf(":")+1, trimmed.length());
                     weapons1.add(Weapon.getWeaponWithName(weaponType));
                     weaponFrequencies1.add(Integer.parseInt(weaponFrequency));
                  }
               }
               
               weapons[i] = weapons1;
               weaponFrequencies[i] = weaponFrequencies1;   
            }
